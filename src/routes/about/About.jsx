    ...
    <div className="about">
      ...
      <div className="third-paragraph">
        <p>
          ...
          million poor smallholders. Rural households can improve their
          livelihoods by raising a wide variety of animals: cows, buffaloes,
          sheep, goats, pigs, poultry, camels, llamas, alpacas, horses, donkeys,
          rabbits and even bees. It is estimated that the demand for livestock
          products will more than double over the next 20 years, due to
      ...
      <div className="fourth-paragraph">
        <div className="">
          ...
          <p>
            ...
            million poor smallholders. Rural households can improve their
            livelihoods by raising a wide variety of animals: cows, buffaloes,
            sheep, goats, pigs, poultry, camels, llamas, alpacas, horses,
            donkeys, rabbits and even bees. It is estimated that the demand for
            livestock products will more than double over the next 20 years, due
            to urbanization, economic growth and a change in consumption
            ...
            market demand, largely from urban areas. These requirements relate
            to food quality, food safety and consistency of supply. A game
            changer for rural families
          </p>
        </div>
        <div className="">
          <img src={photo} alt="" />
